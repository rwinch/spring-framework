...
/**
 * Convenience class for building an {@link HtmlUnitDriver} that will delegate
 * to {@link MockMvc} and optionally delegate to an actual connection for
 * specific requests.
 *
 * <p>By default {code localhost} will delegate to {@code MockMvc}, and any
 * other URL will delegate to an actual connection.
 *
 * @author Rob Winch
 * @author Sam Brannen
 * @since 4.2
