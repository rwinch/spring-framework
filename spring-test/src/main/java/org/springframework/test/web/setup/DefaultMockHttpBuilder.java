...
import org.springframework.test.web.RequestBuilder;
import org.springframework.test.web.ResultHandler;
import org.springframework.test.web.ResultMatcher;
...
public class DefaultMockHttpBuilder {
	...
	private final List<ResultMatcher<? extends HttpResult>> globalResultMatchers = new ArrayList<>();

	private final List<ResultHandler<? extends HttpResult>> globalResultHandlers = new ArrayList<>();

	private Boolean dispatchOptions = Boolean.TRUE;

	private final List<MockHttpConfigurer<?>> configurers = new ArrayList<>(4);
	...
	@SuppressWarnings("unchecked")
	public final DefaultMockHttpBuilder apply(MockHttpConfigurer<? extends HttpResult> configurer) {
