 ...
 * @since 3.2
 */
public class PrintingHttpResultHandler<T extends HttpResult> implements HttpResultHandler<T> {
	 ...
	 */
	protected PrintingHttpResultHandler(ResultValuePrinter printer) {
	 ...
	 */
	@Override
	public final void handle(T result) throws Exception {
