 ...
 * @since 3.2
 */
public class HttpXpathResultMatchers {
	 ...
	 */
	protected HttpXpathResultMatchers(String expression, Map<String, String> namespaces, Object ... args)
	 ...
	 */
	public HttpResultMatcher<HttpResult> nodeCount(final Matcher<Integer> matcher) {
		return new HttpResultMatcher<HttpResult>() {
			@Override
			public void match(HttpResult result) throws Exception {
				MockHttpServletResponse response = result.getResponse();
	 ...
	 */
	public HttpResultMatcher<HttpResult> nodeCount(final int expectedCount) {
		return new HttpResultMatcher<HttpResult>() {
			@Override
			public void match(HttpResult result) throws Exception {
				MockHttpServletResponse response = result.getResponse();
	 ...
	 */
	public HttpResultMatcher<HttpResult> string(final String expectedValue) {
		return new HttpResultMatcher<HttpResult>() {
			@Override
			public void match(HttpResult result) throws Exception {
				MockHttpServletResponse response = result.getResponse();
	 ...
	 * given Hamcrest {@link Matcher}.
	 */
	public HttpResultMatcher<HttpResult> number(final Matcher<? super Double> matcher) {
		return new HttpResultMatcher<HttpResult>() {
			@Override
			public void match(HttpResult result) throws Exception {
				MockHttpServletResponse response = result.getResponse();
	 ...
	 */
	public HttpResultMatcher<HttpResult> number(final Double expectedValue) {
		return new HttpResultMatcher<HttpResult>() {
			@Override
			public void match(HttpResult result) throws Exception {
				MockHttpServletResponse response = result.getResponse();
	 ...
	 */
	public HttpResultMatcher<HttpResult> booleanValue(final Boolean value) {
		return new HttpResultMatcher<HttpResult>() {
			@Override
			public void match(HttpResult result) throws Exception {
				MockHttpServletResponse response = result.getResponse();
