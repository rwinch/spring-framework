...
/**
 * A simple implementation of {@link HttpResult} with setters.
 *
 * @author Rossen Stoyanchev
 * @author Rob Winch
 * @since 3.2
 */
class DefaultHttpResult implements HttpResult {
	 ...
	 */
	public DefaultHttpResult(MockHttpServletRequest request, MockHttpServletResponse response) {
	...
	public Object getAsyncResult(long timeToWait) {
		...
		if (result == RESULT_NONE) {
			throw new IllegalStateException("Async result was not set during the specified timeToWait=" + timeToWait);
		}
		return result;
	}
